...
<div id="content-wrapper">
            <div class="container-fluid upload-details">
               <div class="row">
                  ...
                  <div class="col-lg-10">
                     <div class="osahan-title">Teste</div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="form-group">
                                 <label for="e1">Título do Curso:</label>
                                 <input type="text" placeholder="Título" id="e1" class="form-control">
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="form-group">
                                 <label for="e2">Descrição:</label>
                                 <textarea rows="3" id="e2" name="Descrição" class="form-control">Description</textarea>
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="form-group">
                                 <label for="e2">Objectivos do curso:</label>
                                 <textarea rows="3" id="e2" name="Objectivos" class="form-control">Description</textarea>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-lg-3">
                              <div class="form-group">
                                 ...
                                 <input type="text" placeholder="2500 MZN" id="e1" class="form-control">
                              </div>
                           </div>
                           <div class="col-lg-3">
                              <div class="form-group">
                                 <label for="e1">Total de vídeos do Curso:</label>
                                 <input type="text" placeholder="55 vídeos" id="e1" class="form-control">
                              </div>
                           </div>
                           <div class="col-lg-3">
                              <div class="form-group">
                                 <label for="e1">Duração do Curso:</label>
                                 <input type="text" placeholder="1 semana" id="e1" class="form-control">
                              </div>
                           </div>
                           <div class="col-lg-3">
                              <div class="form-group">
                                 <label for="e1">ID do Canal:</label>
                                 <input type="text" placeholder="10" id="e1" class="form-control">
                              </div>
                           </div>
                        </div>
                        <!-- <div class="row">
